...
// rot is in degrees
{
	...
	// get zeroth line
	getElevationLineTiles(nextline, width, -height, lat, lng, scaleFactor, rot, waterDrop, baseHeight, stepSize, &ta);
	...
	for (int y = -height + 1; y <= 0; y++)
	{
		...
		getElevationLineTiles(nextline, width, y, lat, lng, scaleFactor, rot, waterDrop, baseHeight, stepSize, &ta);
	...
	// free allocated memory for height tiles
